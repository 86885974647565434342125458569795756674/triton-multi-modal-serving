    ...
    while True:
        ...
        while text_batch_input_count<text_batch_num or text_batch_output_count<text_batch_num:
            ...
            try:
                ...
                if now_left.shape[0]>=blip_vqa_text_encoder_batches[text_batch_input_count].shape[0]:
    ...
    while True:
        ...
        while text_batch_input_count<text_batch_num or text_batch_output_count<text_batch_num:
            ...
            try:
                ...
                if now_left.shape[0]>=blip_vqa_text_decoder_batches[text_batch_input_count].shape[0]:
